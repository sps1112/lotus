...
int main()
{
    ...
    Lotus::Rendering::SRefShader shader = std::make_shared<Lotus::Rendering::Shader>(
    ...
    Lotus::Rendering::SRefShader skyShader = std::make_shared<Lotus::Rendering::Shader>(
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::mat4 projection = glm::perspective(glm::radians(camera->getFieldOfView()), (float)SCR_WIDTH / (float)SCR_HEIGHT, 0.1f, 100.0f);
